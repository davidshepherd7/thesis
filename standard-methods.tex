...
It should be noted that the geometric properties of IMR derived in ??ds are only true up to the accuracy with which we solve the LLG (and similar statements are true for the other geometric integration schemes mentioned).
...
d'Aquino used a quasi-Newton method to handle this (although he used FFT magnetostatics).

The fully implicit FEM/BEM method given in \autoref{sec:fully-implicit-bem} is an efficent method retaining the full conservation properties.
