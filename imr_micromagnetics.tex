...
Discussion-- bdf2 accuracy no good even with normalisation, probably due to L-stability.
TR accuracy is good, but requires renormalisation, and is less stable.
