...
Continuing from equation~\cref{eq:trunc-mid} at the end of \cref{sec:deriv-local-trunc}.
...
\end{equation}
Substituting in the Taylor expansions for $\yv(t_n)$ and $\yv(t_{n+1})$ about $\thf$ (from equations~\cref{eq:taylornp1} and \cref{eq:taylorn}) gives
\begin{equation}
  \begin{aligned}
