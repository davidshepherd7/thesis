...
\section{Evaluation Of Integrals}

\subsection{Discussion Of The Integrands}

\subsubsection{Finite Element Integrals}
...
\subsubsection{Hybrid Boundary Element Integrals}
...
In $d$ dimensions for target node $i$ and source node $j$ (see Section~\ref{sec:hybr-finit-elem}, equation~\eqref{eq:19}) the non-constant part of the boundary element integral is:
\begin{equation}
  \label{eq:7}
...
\subsection{Standard Quadrature Schemes}
...
\subsubsection{Gaussian Quadratures}
\begin{itemize}
...
\subsubsection{Adaptive quadratures}
...
\subsubsection{$\epsilon$-algorithms}
...
\subsection{Evaluating Singular And Near-Singular Integrals}

\subsubsection{Existance Of Singular Integrals}
...
\subsubsection{Special Quadrature Schemes}
...
\subsubsection{Removal Of Singularity}
...
\subsection{Application To Finite Element and Hybrid Micromagnetics}
...
However for the boundary element part of a hybrid model some integrals are singular or nearly-singular (see Section~\ref{sec:discretisation}). This requires the use of more complex and/or higher order schemes.

\subsubsection{Other Boundary Element and Hybrid BEM/FEM Codes}
...
\subsubsection{Choice of Quadrature Scheme}
