...
So substituting the basis representations, \cref{ll-eq:unknowns-basis} and \cref{ll-eq:47} into the residuals we obtain a spatially discretised version of the problem.
%% \begin{gather}
%%   \label{ll-res:tintro}
