...
The bulk equations~\eqref{eq:phi-bem-continuous} and the Neumann boundary condition on $\phione$ in \eqref{eq:phi-bem-continuous-bc} are identical to those discussed in \autoref{sec:llg-initial-equations}.
