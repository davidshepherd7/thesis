...
We introduce notation for the midpoint values of $t$ and $\yv$:
\begin{equation}
  \begin{aligned}
    \thf & = \frac{t_{n+1} + t_n}{2}, \\
...
All three are sufficiently stable and accurate for general use in PDE applications. ??ds citation, explination?
...
Explicit methods are never A-stable ??ds check? \cite{??ds}, which is the main reason this thesis focuses on implicit methods.
