...
In \thisref{sec:properties-of-field-operators} we show some properties of the effective field operator that are used elsewhere in this thesis.
...
In \thisref{sec:linear-symm-field-operators} we make heavy use of a consequence of the divergence theorem:
\begin{equation}
...
For the exchange effective field we use, from \cref{eq:93}, that
\begin{equation}
