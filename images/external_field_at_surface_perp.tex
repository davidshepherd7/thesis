...
\begingroup
  ...
  \begin{picture}(7200.00,5040.00)%
    \gplgaddtomacro\gplbacktext{%
      ...
      \put(176,2541){\makebox(0,0){\strut{}$\dfrac{-H_{m,z}}{M_s}$}}}%
      \put(3940,154){\makebox(0,0){\strut{}$\rho$}}%
      \put(3940,4709){\makebox(0,0){\strut{}Perpendicular}}%
    }%
    \gplgaddtomacro\gplfronttext{%
    }%
    \gplbacktext
    \put(0,0){\includegraphics{perp_rec/external_field_at_surface_perp}}%
    \gplfronttext
  \end{picture}%
\endgroup
