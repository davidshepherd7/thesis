...
However IMR takes significantly smaller time steps during the initial relaxation phase, this is likely due to the order reduction effect (see \cref{sec:order-reduction}):
...
The adaptive time integration scheme detects and accounts for this effect.
\begin{figure}
  \centering
...
We focus on the case of field 2 and use monolithic magnetostatics.
...
However, recall that our implementation of IMR with magnetostatics does not conserve energy.
...
\begin{figure}
  ...
  \caption{Mean $y$ component of the magnetisation for the \mumag problem 4 with field 2 solved using IMR, monolithic coupling, both quadrature schemes and varying spatial resolutions.
