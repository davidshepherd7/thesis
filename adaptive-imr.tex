...
However when used in finite-element or finite-difference calculations the number of $y$-values is at least tens of thousands.
...
The implementation of the three time integration algorithms without re-normalisation of $\mv$ is exactly as discussed in \cref{sec:aimr-implementation}.
...
%??paper -- pull in explanation from later of why I use mean(min(residual))?
