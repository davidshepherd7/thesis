...
Equivalent plots for the other example problems presented here are very similar and so are not shown.
...
\begin{figure}
  ...
  \caption{Convergence plots of the error in magnetisation, \cref{eq:m-sphere-error}, against average time step for constant step IMR, adaptive IMR, adaptive TR and adaptive BDF2. ??ds zoom in, remove guidelines, Better legend position + text}
