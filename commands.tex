...
\newcommand{\tsbasis}{{S_h^1(\magd)}} % test/shape basis functions
...
\newcommand{\mumag}{\textmu{}mag\ }
\newcommand{\oomph}{\texttt{oomph-lib}}
\newcommand{\nmag}{Nmag}
\newcommand{\magpar}{magpar}
\newcommand{\femme}{femme}
\newcommand{\oommf}{OOMMF}

\newcommand{\hypre}{Hypre}
\newcommand{\superlu}{SuperLU}
\newcommand{\hlib}{HLib}
...
\newcommand{\nowy}{\nlit{\yvdis}{0}}
\newcommand{\nexty}{\yvdis^E}
\newcommand{\corr}{\boldsymbol{\delta}}
