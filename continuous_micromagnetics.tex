...
% ??ds fix check this in more detail, should we be using energy density? Add definition of variational derivative? -- Andrew
...
% ??ds fix could add better derivation or a citation? -- Andrew, check the M_s factors: should this be \mv?
