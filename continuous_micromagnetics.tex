...
In particular, it is true for the dot product of two vectors (also known as scalar multiplication) and for the $\ltwo$ inner product of two vector functions $\av$, $\bv$:
\begin{equation}
