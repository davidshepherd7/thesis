...
\newcommand{\manydatapointsPrecLegend}{Data points for all values of $\dampc$, $\dtn$, and $\kone$; and for both formats of the BEM block are shown but are not distinguished.}
