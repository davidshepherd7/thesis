...
% ??ds fix Hans wants to add note that this is what nmag, and probably magpar + femme do, find citations?!
...
\begin{figure}
  ...
  \caption{The test problem used for the linear solvers in the state at time $t=0$.
    ...
    % ??ds fix Add axis labels in the plot -- Andrew
  }
...
%??ds fix lots to do in this section, need to replace plots by means + stddev for one thing.
% When you do this remember to also change the plots in ch. 8
