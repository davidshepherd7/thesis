...
Hence the performance on the standard problem would be irrelevant for realistic problems using this method and the computational cost would be unnecessarily large.
...
Based on all these factors we can estimate that, with an effective preconditioner, the computational time for a monolithic time step should easily be within a factor of 2 of the time for a semi-implicit step.
