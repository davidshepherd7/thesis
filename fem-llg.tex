...
% ??ds "Probably need to be careful about linear independence"  -- Andrew
...
% ??ds Check "which" triangle inequality, also this uses a different tri. ineq. to the other one  -- Andrew
\begin{equation}
