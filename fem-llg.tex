...
In \thisref{sec:galerk-meth-llg} we introduce first give a general introduction to the finite element method.
...
\end{equation}
Since $y_{h}\in V_{S}^{h}$ we can also replace $y_{h}$ by a linear combination of the basis functions, \ie
\begin{equation}
