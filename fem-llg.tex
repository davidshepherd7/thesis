...
\emph{Nodal integration} is the standard term for quadrature schemes where the nodal values are used directly in the quadrature (typically with mesh-free methods \eg \cite{Puso2008}), but prefer the term ``nodal quadrature'' to avoid confusion with time integration.
