...
However this a pessimistic bound because it assumes that every coefficient of the basis expansion has the same sign, \ie all effective fields are in the same direction over all of $\magd$, and $\dmdt$ is in the opposite direction over all of $\magd$.
The actual error is not likely to be this large except in extremely symmetric cases.
...
% % ??ds does this make sense for the LLG? or do we need to go to LL form? -- probably only LL
