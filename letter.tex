...
% ??ds first draft
\item While I agree that the comparison with finite difference methods is potentially harsher than necessary I believe that it is extremely important to verify the model by comparing against results for some standard problem.
