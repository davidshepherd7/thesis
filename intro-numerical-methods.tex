...
Some examples of such schemes are based on IMR \cite{DAquino2005}, or a semi-explicit extension of IMR using explicit extrapolations of the effective field \cite{Spargo2003,Serpico2001}.
...
Hence constructing the subspace is computationally cheap for a sparse matrix $\mat$.
...
\begin{equation}
  \begin{aligned}
    \Bm \xv &= \cv, \quad \Bm = \precond^{-1} \mat, \quad \cv = \precond^{-1} \bv,
  \end{aligned}
\end{equation}
