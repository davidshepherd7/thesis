...
In the same manner as the \cref{sec:proof-magn-length-ode-imr-llg} we derive the change in energy of the discrete LLG equation by taking the $\ltwo$ inner product of \cref{eqn:disc-llg} with
\begin{equation}
