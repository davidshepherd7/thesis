...
\begin{align*}
  M_s \hv &= M_s \happ - \frac{\Phi}{l} \nabla \phi + \frac{2 \Exchc }{\mu_0 M_s} \frac{1}{l^2} \nabla^2 \mv + \frac{2\kone}{\mu_0 M_s}  \nK (\mv \cdot \ev) \ev, \\
  \hv &= \frac{M_s}{M_s} \happ - \frac{M_s}{M_s} \nabla \phi + \frac{2 \Exchc}{\mu_0 M_s^2} \frac{1}{l^2} \nabla^2 \mv + \frac{2\kone}{\mu_0 M_s^2} \nK (\mv \cdot \ev) \ev.
\end{align*}
...
The non-dimensionalisation of the Landau-Lifshitz form (equation~\eqref{eq:LLG}) of the Landau-Lifshitz-Gilbert equation is essentially the same except for one change: the time variable is normalised differently to remove the factor of $(1 + \dampc^2)$. This gives us
\begin{equation}
